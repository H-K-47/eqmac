...
Global everquest_gfx_dll_address := 0

Global spawn_id_list := Array()

Global spawn_id_index := 1
...
CameraHack_Enable()
{
    ...
    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetFog + EVERQUEST_OFFSET_GFX_DLL_t3dSetFog_FOG_DRAW_DISTANCE_START, EVERQUEST_GFX_DLL_t3dSetFog_FOG_DRAW_DISTANCE_START_SIZE)

    Memory_WriteFloat(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_FOG_DRAW_DISTANCE_START, EVERQUEST_DRAW_DISTANCE_MAX)

    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_Y, EVERQUEST_GFX_DLL_t3dSetCameraLocation_Y_SIZE)
    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_X, EVERQUEST_GFX_DLL_t3dSetCameraLocation_X_SIZE)
    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_Z, EVERQUEST_GFX_DLL_t3dSetCameraLocation_Z_SIZE)

    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_HEADING, EVERQUEST_GFX_DLL_t3dSetCameraLocation_HEADING_SIZE)
    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_PITCH,   EVERQUEST_GFX_DLL_t3dSetCameraLocation_PITCH_SIZE)

    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens_FIELD_OF_VIEW, EVERQUEST_GFX_DLL_t3dSetCameraLens_FIELD_OF_VIEW_SIZE)
    Memory_WriteNops(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens_DRAW_DISTANCE, EVERQUEST_GFX_DLL_t3dSetCameraLens_DRAW_DISTANCE_SIZE)
...
CameraHack_Disable()
{
    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetFog + EVERQUEST_OFFSET_GFX_DLL_t3dSetFog_FOG_DRAW_DISTANCE_START, EVERQUEST_GFX_DLL_t3dSetFog_FOG_DRAW_DISTANCE_START_BYTES)

    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_Y, EVERQUEST_GFX_DLL_t3dSetCameraLocation_Y_BYTES)
    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_X, EVERQUEST_GFX_DLL_t3dSetCameraLocation_X_BYTES)
    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_Z, EVERQUEST_GFX_DLL_t3dSetCameraLocation_Z_BYTES)

    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_HEADING, EVERQUEST_GFX_DLL_t3dSetCameraLocation_HEADING_BYTES)
    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLocation_PITCH,   EVERQUEST_GFX_DLL_t3dSetCameraLocation_PITCH_BYTES)

    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens_FIELD_OF_VIEW, EVERQUEST_GFX_DLL_t3dSetCameraLens_FIELD_OF_VIEW_BYTES)
    ;;Memory_WriteBytes(everquest_process_handle, everquest_gfx_dll_address + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens + EVERQUEST_OFFSET_GFX_DLL_t3dSetCameraLens_DRAW_DISTANCE, EVERQUEST_GFX_DLL_t3dSetCameraLens_DRAW_DISTANCE_BYTES)
...
CameraGoToSpawnIndex(spawn_index)
{
    ...
    Loop, %EVERQUEST_SPAWNS_MAX%
    {
        ...
        spawn_id := Memory_ReadEx(everquest_process_handle, spawn_info_address + EVERQUEST_OFFSET_SPAWN_INFO_SPAWN_ID, 2)

        If (spawn_id = spawn_id_list[spawn_index])
        {
            ...
            spawn_z := spawn_z + spawn_avatar_height + 1 + (spawn_avatar_height / 2)
...
If (joy_pov = 0)
{
    ...
    spawn_id := Memory_ReadEx(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_SPAWN_ID, 2)

    spawn_y := Memory_ReadFloat(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_Y)
    spawn_x := Memory_ReadFloat(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_X)
    spawn_z := Memory_ReadFloat(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_Z)

    spawn_heading := Memory_ReadFloat(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_HEADING)

    spawn_avatar_height := Memory_ReadFloat(everquest_process_handle, player_spawn_info + EVERQUEST_OFFSET_SPAWN_INFO_AVATAR_HEIGHT)
...
If (joy_pov = 27000)
{
    ...
    If (spawn_id_index < 1)
    {
        spawn_id_index := spawn_id_list.MaxIndex()
    }

    CameraGoToSpawnIndex(spawn_id_index)
...
If (joy_pov = 9000)
{
    ...
    If (spawn_id_index > spawn_id_list.MaxIndex())
    {
        spawn_id_index := 1
    }
