...
If (target_spawn_info = target_1)
{
    Memory_Write(everquest_process_handle, EVERQUEST_TARGET_SPAWN_INFO_POINTER, target_2)
}
Else
{
    Memory_Write(everquest_process_handle, EVERQUEST_TARGET_SPAWN_INFO_POINTER, target_1)
}
Return
