...
CDisplay **ppCDisplay = (CDisplay**)EQ_CDisplay_POINTER;
...
public:
    ...
    int CEverQuest::MoveToZone(char* zone_short_name, char* text, int destination_type, int zone_request_reason);
    int CEverQuest::MoveToZone(int zone_id, char* text, int destination_type, int zone_request_reason);
    int CEverQuest::LootCorpse(class EQPlayer *, int unknown);
};

CEverQuest **ppCEverQuest = (CEverQuest**)EQ_CEverQuest_POINTER;
...
EQ_Character **ppEQ_Character = (EQ_Character**)EQ_EQ_Character_POINTER;
...
CHotButtonWnd **ppCHotButtonWnd = (CHotButtonWnd**)EQ_CHotButtonWnd_POINTER;
...
CLootWnd **ppCLootWnd = (CLootWnd**)EQ_CLootWnd_POINTER;
...
CTradeWnd **ppCTradeWnd = (CTradeWnd**)EQ_CTradeWnd_POINTER;
...
FUNCTION_AT_ADDRESS(void CDisplay::MoveLocalPlayerToSafeCoords(void), EQ_FUNCTION_CDisplay__MoveLocalPlayerToSafeCoords);
#endif
...
FUNCTION_AT_ADDRESS(void CEverQuest::dsp_chat(char const *,short,bool), EQ_FUNCTION_CEverQuest__dsp_chat);
#endif

// CEverQuest::dsp_chat((char const *))
#define EQ_FUNCTION_CEverQuest__dsp_chat2 0x005380FD
#ifdef EQ_FUNCTION_CEverQuest__dsp_chat2
FUNCTION_AT_ADDRESS(void CEverQuest::dsp_chat(char const *), EQ_FUNCTION_CEverQuest__dsp_chat2);
#endif
...
FUNCTION_AT_ADDRESS(int CEverQuest::MoveToZone(char*, char*, int, int), EQ_FUNCTION_CEverQuest__MoveToZone);
#endif
...
FUNCTION_AT_ADDRESS(int CEverQuest::MoveToZone(int, char*, int, int), EQ_FUNCTION_CEverQuest__MoveToZone2);
#endif
...
FUNCTION_AT_ADDRESS(int CEverQuest::LootCorpse(class EQPlayer *, int), EQ_FUNCTION_CEverQuest__LootCorpse);
#endif
...
FUNCTION_AT_ADDRESS(void CHotButtonWnd::DoHotButton(short, int), EQ_FUNCTION_CHotButtonWnd__DoHotButton);
#endif

// CLootWnd::Deactivate(void)
#define EQ_FUNCTION_CLootWnd__Deactivate 0x0042651F
#ifdef EQ_FUNCTION_CLootWnd__Deactivate
FUNCTION_AT_ADDRESS(void CLootWnd::Deactivate(void), EQ_FUNCTION_CLootWnd__Deactivate);
#endif
...
FUNCTION_AT_ADDRESS(void CLootWnd::RequestLootSlot(int, bool), EQ_FUNCTION_CLootWnd__RequestLootSlot);
#endif

// CTradeWnd::Activate(EQPlayer *,bool)
#define EQ_FUNCTION_CTradeWnd__Activate 0x004392C9
#ifdef EQ_FUNCTION_CTradeWnd__Activate
FUNCTION_AT_ADDRESS(void CTradeWnd::Activate(class EQPlayer *, bool), EQ_FUNCTION_CTradeWnd__Activate);
#endif

// EQPlayer::ChangeHeight((float))
#define EQ_FUNCTION_EQPlayer__ChangeHeight 0x0050C160
#ifdef EQ_FUNCTION_EQPlayer__ChangeHeight
FUNCTION_AT_ADDRESS(void EQPlayer::ChangeHeight(float), EQ_FUNCTION_EQPlayer__ChangeHeight);
#endif
...
FUNCTION_AT_ADDRESS(void EQPlayer::ChangePosition(unsigned char), EQ_FUNCTION_EQPlayer__ChangePosition);
#endif

// EQPlayer::FacePlayer(EQPlayer*)
#define EQ_FUNCTION_EQPlayer__FacePlayer 0x00508120
#ifdef EQ_FUNCTION_EQPlayer__FacePlayer
FUNCTION_AT_ADDRESS(void EQPlayer::FacePlayer(class EQPlayer *), EQ_FUNCTION_EQPlayer__FacePlayer);
#endif
...
FUNCTION_AT_ADDRESS(unsigned short EQ_Character::Max_Mana(void), EQ_FUNCTION_EQ_Character__Max_Mana);
#endif
...
#define EQ_FUNCTION__sprintf 0x005C5F6C

/*
// CDisplay::WriteTextHD2((char const *,int,int,int,T3D_FONT *))
#define EQ_FUNCTION_CDisplay__WriteTextHD2 0x004AA5AA // 0x004A0A95?
...
_everquest_function_CDisplay__WriteTextHD2 everquest_function_CDisplay__WriteTextHD2 = (_everquest_function_CDisplay__WriteTextHD2)EQ_FUNCTION_CDisplay__WriteTextHD2;
#endif
